...
namespace AirCode.Utilities.HelperScripts
{
    ...
    public static class JsonHelper
    {
        ...
        /// </summary>
        /// <param name="json">The JSON string to convert</param>
        /// <returns>YAML string or null if conversion fails</returns>
        public static string JsonToYaml(string json)
        {
            try
            {
                ...
                var yamlObject = deserializer.Deserialize(new JsonTextReader(new StringReader(json)));
            ...
            {
                MID_HelperFunctions.DebugMessage($"JSON to YAML conversion error: {ex.Message}", DebugClass.Exception);
                return null;
            }
        }
        ...
        /// <param name="indented">Whether to format the JSON with indentation</param>
        /// <returns>JSON string or null if conversion fails</returns>
        public static string YamlToJson(string yaml, bool indented = false)
        {
            try
            {
                if (!MID_HelperFunctions.IsValidString(yaml))
                    return null;
            ...
            {
                MID_HelperFunctions.DebugMessage($"YAML to JSON conversion error: {ex.Message}", DebugClass.Exception);
                return null;
            }
        }
